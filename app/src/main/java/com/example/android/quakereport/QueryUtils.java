...
public final class QueryUtils {
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        if (url == null) {
            Log.e("URL Error", "There's no URL provided");
            return jsonResponse;
        }
        ...
        try {
            ...
            // If the request was accepted (response code 200
    ...
    public static List<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            // Creates a JSONObject from JSON_RESPONSE
            JSONObject jsonObject = new JSONObject(jsonResponse);

            //Create a JSONArray from features
            ...
            for (int i=0;i<features.length();i++) {
                ...
                String t = properties.getString("time");
                String url = properties.getString("url");
                float magnitude = Float.parseFloat(mag);
                long time = Long.parseLong(t);

                earthquakes.add(i, new Earthquake(magnitude, place, time, url));
